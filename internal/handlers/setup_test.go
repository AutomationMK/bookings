...
func getRoutes() http.Handler {
	...
	mux.Get("/rooms", Repo.Rooms)
	mux.Get("/rooms/deluxe-room", Repo.Deluxe)
	mux.Get("/rooms/premium-suite", Repo.Premium)

	mux.Get("/search-availability", Repo.Availability)
	mux.Post("/search-availability", Repo.PostAvailability)
	mux.Post("/search-availability-json", Repo.AvailabilityJSON)

	mux.Get("/make-reservation", Repo.Reserve)
	mux.Post("/make-reservation", Repo.PostReserve)
...
// createTestTemplateCache loops though all template files when testing
...
func CreateTestTemplateCache() (map[string]*template.Template, error) {
	...
	// range through all files ending with *.page.templ
